...
<div class="container">
    ...
    <div class="row">
      <h2 style="text-align:center">TATA<br>Buy Car & Enjoy Life</h2>
      <div class="vl">
...
<div class="bottom-container">
  <div class="row">
    <div class="col">
        <a href="register.php" style="color:#F7FF4D" class="btn"><h3>Sign up</h3></a>
    </div>
    <div class="col">
...
<?php if(isset($_POST['submit']))
{
	...
	if( $n > 0)
	{
		echo "<script>window.location.href = 'carbuy.php'; </script>";
	}
	else
	{
